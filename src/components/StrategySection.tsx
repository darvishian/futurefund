    ...
    <section className="py-12 sm:py-20 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8 mb-12 sm:mb-16">
          ...
          <div className="bg-gray-900 border border-gray-700 rounded-2xl p-6 sm:p-8 hover:shadow-lg transition-all duration-300">
            <div className="flex items-center mb-4 sm:mb-6">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-white">Bitcoin Strategies</h3>
            </div>
          ...
          <div className="bg-gray-900 border border-gray-700 rounded-2xl p-6 sm:p-8 hover:shadow-lg transition-all duration-300">
            <div className="flex items-center mb-4 sm:mb-6">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-accent/10 rounded-xl flex items-center justify-center mr-3 sm:mr-4">
                <Building className="w-5 h-5 sm:w-6 sm:h-6 text-accent" />
              </div>
              <h3 className="text-lg sm:text-xl font-bold text-white">NNN Real Estate</h3>
            </div>
            <p className="text-white/70 leading-relaxed text-sm sm:text-base">
          ...
          <div className="bg-gray-900 border border-gray-700 rounded-2xl p-6 sm:p-8 hover:shadow-lg transition-all duration-300">
            <div className="flex items-center mb-4 sm:mb-6">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-white">Strategic Partnership with Swig Soda</h3>
            </div>
            <p className="text-white/70 leading-relaxed text-sm sm:text-base">
        ...
        <div className="bg-gray-900 border border-gray-700 rounded-2xl p-6 sm:p-8">
          <h3 className="text-xl sm:text-2xl font-bold text-white mb-6 sm:mb-8 text-center">Strategy Flow</h3>
          <div className="flex flex-col md:flex-row items-center justify-center space-y-4 md:space-y-0 md:space-x-8">
            <div className="text-center">
              <div className="bg-accent/10 rounded-xl p-3 sm:p-4 mb-3">
                <Building className="w-6 h-6 sm:w-8 sm:h-8 text-accent mx-auto" />
              </div>
            ...
            <div className="text-center">
                <div className="bg-primary/10 rounded-xl p-3 sm:p-4 mb-3">
                <TrendingUp className="w-6 h-6 sm:w-8 sm:h-8 text-primary mx-auto" />
              </div>
            ...
            <div className="text-center">
              <div className="bg-accent/10 rounded-xl p-3 sm:p-4 mb-3">
                <TrendingUp className="w-6 h-6 sm:w-8 sm:h-8 text-accent mx-auto" />
              </div>
        ...
        >
          <div className="mt-12 sm:mt-16 grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8">
            <div className="text-center">
              <div className="text-2xl sm:text-3xl font-bold gradient-text mb-1 sm:mb-2">8.35x</div>
              <div className="text-xs sm:text-sm text-white/60">Target MOIC</div>
            </div>
            <div className="text-center">
              <div className="text-2xl sm:text-3xl font-bold gradient-text mb-1 sm:mb-2">28.63%</div>
              <div className="text-xs sm:text-sm text-white/60">IRR (Base Case)</div>
            </div>
            <div className="text-center">
              <div className="text-2xl sm:text-3xl font-bold gradient-text mb-1 sm:mb-2">2,168</div>
              <div className="text-xs sm:text-sm text-white/60">BTC Owned by 2035</div>
            </div>
            <div className="text-center">
              <div className="text-2xl sm:text-3xl font-bold gradient-text mb-1 sm:mb-2">$2.2B</div>
              <div className="text-xs sm:text-sm text-white/60">BTC Treasury Value</div>
            </div>
          </div>
        </EmailGate>
        ...
        <div className="mt-16 sm:mt-20">
          <div className="text-center mb-8 sm:mb-12">
            <div className="flex items-center justify-center mb-6">
              <Target className="w-6 h-6 sm:w-8 sm:h-8 text-primary mr-3" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 mb-12 sm:mb-16">
            {/* Existing Approach */}
            <div className="bg-gray-900 border border-gray-700 rounded-2xl p-6 sm:p-8">
              <h3 className="text-lg sm:text-xl font-bold text-white mb-4 sm:mb-6 text-center">Existing Bitcoin Treasury Companies</h3>
            ...
            {/* Our Approach */}
            <div className="bg-gray-900 border border-primary/30 rounded-2xl p-6 sm:p-8">
              <h3 className="text-lg sm:text-xl font-bold text-white mb-4 sm:mb-6 text-center">Our Fund Strategy</h3>
              <div className="space-y-4">
                <div className="flex items-start">
          ...
          {/* Companies Table */}
          <div className="bg-gray-900 border border-gray-700 rounded-2xl p-6 sm:p-8">
            <h3 className="text-xl sm:text-2xl font-bold text-white mb-6 sm:mb-8 text-center">Bitcoin Treasury Companies Comparison</h3>
